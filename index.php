...
<head>
	...
	<title>CLINICA SEÑOR DE LUREN</title>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="" class="navbar-brand">HISTORIAS CLINICA</a>
				</div>
...
<?php
	if(isset($_POST['txtpass'])) 
	{
		...
		$mysqli = new mysqli("localhost", "root", "", "csl_hc") or die ("Error de conexion porque: ".$mysqli->connect_errno);
